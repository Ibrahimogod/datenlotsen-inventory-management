...
{
    private readonly Mock<IRepository<InventoryItem, Guid>> _inventoryRepositoryMock;
    private readonly InventoryService _service;

    public InventoryServiceTests()
    {
        _inventoryRepositoryMock = new Mock<IRepository<InventoryItem, Guid>>();
        _service = new InventoryService(_inventoryRepositoryMock.Object);
    }
    ...
    public async Task GetByIdAsync_ReturnsItem_WhenFound()
    {
        ...
        _inventoryRepositoryMock.Setup(r => r.GetSingleAsync(It.IsAny<Expression<Func<InventoryItem, InventoryItemModel>>>(),
    ...
    {
        _inventoryRepositoryMock.Setup(r => r.GetSingleAsync(It.IsAny<Expression<Func<InventoryItem, InventoryItemModel>>>(), It.IsAny<Expression<Func<InventoryItem, bool>>>(), true, It.IsAny<CancellationToken>()))
    ...
    public async Task CreateAsync_ReturnsCreatedResult()
    {
        ...
        _inventoryRepositoryMock.Setup(r => r.AddAsync(It.IsAny<InventoryItem>(), It.IsAny<CancellationToken>())).ReturnsAsync(entity);
    ...
    public async Task UpdateAsync_CallsRepository()
    {
        var id = Guid.NewGuid();
        var called = false;
        _inventoryRepositoryMock.Setup(r => r.UpdateAsync(id, It.IsAny<Action<InventoryItem>>(), It.IsAny<CancellationToken>()))
    ...
    {
        _inventoryRepositoryMock.Setup(r => r.GetAllAsync(It.IsAny<Expression<Func<InventoryItem, InventoryItemModel>>>(), It.IsAny<Expression<Func<InventoryItem, bool>>>(), true, null, null, null, It.IsAny<CancellationToken>()))
    ...
    public async Task DeleteAsync_CallsRepository()
    {
        var id = Guid.NewGuid();
        var called = false;
        _inventoryRepositoryMock.Setup(r => r.DeleteAsync(id, It.IsAny<CancellationToken>())).Callback(() => called = true).Returns(ValueTask.CompletedTask);
